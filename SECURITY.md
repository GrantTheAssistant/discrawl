...
archives, database rows, tokens, cookies, or message contents in reports.

## Scope

In scope:

- local Discord archive, cache, SQLite, and filesystem handling
...
- Discord service outages, API changes, or account enforcement decisions
